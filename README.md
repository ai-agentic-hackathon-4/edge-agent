...
4. **get_bh1750_data**: BH1750照度センサーからデータ取得
5. **control_air_conditioner**: 赤外線リモコン経由でエアコン制御
6. **control_humidifier**: 加湿器制御
7. **control_pump**: ポンプ制御（給水）
