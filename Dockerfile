...
# Ensure python output is sent directly to terminal (stdout) without buffering
...
CMD ["adk", "api_server", "agent", "--session_service_uri", "sqlite:////app/data/sessions.db", "--host", "0.0.0.0", "--port", "8080"]
